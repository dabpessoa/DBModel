...
import me.dabpessoa.gui.components.TabelaUICorpo;
import me.dabpessoa.gui.components.TabelaUIFKs;
import me.dabpessoa.gui.components.TabelaUINKs;
import me.dabpessoa.gui.components.TabelaUIPKs;
import me.dabpessoa.gui.components.TabelaUITitulo;
import me.dabpessoa.persistence.EditListener;
	...
	*/
	...
	public void initGUI() {
		try {
	        ...
	        try { fundo = ImageIO.read(new File("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"titleBack.png")); }
	...
	public void updateTable(Tabela tabela) {
		...
		ImageIcon iconT = new ImageIcon(ImageUtils.redimensiona("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"titulo1.png", 16, 16));
		...
		for (int i = 0 ; i < tabela.getAtributos().size() ; i++) {
			...
			if (tabela.getAtributos().get(i).isChavePrimaria()) {
				icon = new ImageIcon(ImageUtils.redimensiona("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"pk.png", 8, 8));
				...
				icon = new ImageIcon(ImageUtils.redimensiona("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"unique.png", 8, 8));
				JLabel jl = new JLabel(tabela.getAtributos().get(i).getNome() + ": " + tabela.getAtributos().get(i).getTipo().getNome(), icon, JLabel.LEFT);
				corpoNK.add(jl);
			} else if (tabela.getAtributos().get(i).getIntegritRestriction() != null){
				icon = new ImageIcon(ImageUtils.redimensiona("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"fk.png", 8, 8));
				JLabel jl = new JLabel(tabela.getAtributos().get(i).getNome() + ": " + tabela.getAtributos().get(i).getTipo().getNome(), icon, JLabel.LEFT);
				corpoFK.add(jl);
			} else {
				icon = new ImageIcon(ImageUtils.redimensiona("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"atributoIcon.png", 8, 8));
				JLabel jl = new JLabel(tabela.getAtributos().get(i).getNome() + ": " + tabela.getAtributos().get(i).getTipo().getNome(), icon, JLabel.LEFT);
				corpoNK.add(jl);
			}
...
//		ImageIcon icon2 = ImageUtils.createImageIcon(this, "../resources/titulo1.png", "Tabela");
		ImageIcon icon = new ImageIcon(ImageUtils.redimensiona("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"titulo1.png", 16, 16));
