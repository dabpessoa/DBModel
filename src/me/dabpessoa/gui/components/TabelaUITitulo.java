...
public class TabelaUITitulo extends JPanel {
	...
	public void chamarRedimensionar() {
		img = ImageUtils.redimensiona("src"+File.separator+"me"+File.separator+"dabpessoa"+File.separator+"resources"+File.separator+"titleBack.png", this.getParent().getPreferredSize().width, this.getPreferredSize().height+5);
	}
