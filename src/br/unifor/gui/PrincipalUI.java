...
import br.unifor.gui.components.About;
import br.unifor.persistence.RelationShipListener;
...
//        menuBar.add(createMenu("Menu 3"));
		...
		Image im = ImageUtils.redimensiona("src"+File.separator+"br"+File.separator+"unifor"+File.separator+"resources"+File.separator+"addTable.png", 18, 18);
		...
		Image im2 = ImageUtils.redimensiona("src"+File.separator+"br"+File.separator+"unifor"+File.separator+"resources"+File.separator+"relationship.png", 18, 18);
		...
		Image im3 = ImageUtils.redimensiona("src"+File.separator+"br"+File.separator+"unifor"+File.separator+"resources"+File.separator+"gerar.png", 18, 18);
...
//        	int height = listaTabelas.get(i).getHeight();
    ...
    public void createAndShowGUI() {
        ...
        frame.setIconImage(frame.getToolkit().getImage(getClass().getResource("/br/unifor/resources/logo.png")));
